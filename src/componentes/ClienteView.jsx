    ...
    return (
        <div>
            ...
            <div className='row'>
                ...
                <div className='col-6'>
                    <div className='card text-center'>a
                        <div className='card-body'>
                            <h5 className="card-title alert alert-info">ADMINISTRAR USUARIOS</h5>
                            <div className='card'>
                                <div className='card-body'>
                                    <Link to="/registroUsuario" className='btn btn-success' onClick={<Navigate to='/registroUsuario' />}>Nuevo</Link>
                                </div>
